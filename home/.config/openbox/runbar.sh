...
$HOME/.config/openbox/bar.sh | lemonbar -p -g ${barwidth}x16+0+0 \
    -F '#d3d0c8' -B '#2d2d2d' \
    -o -1 -f '-gohu-gohufont-medium-r-normal--14-*-*-*-*-*-*-*' \
    -o -1 -f '-gohu-gohufont-bold-r-normal--14-*-*-*-*-*-*-*' \
    -o 1 -f "Font Awesome" | bash &
